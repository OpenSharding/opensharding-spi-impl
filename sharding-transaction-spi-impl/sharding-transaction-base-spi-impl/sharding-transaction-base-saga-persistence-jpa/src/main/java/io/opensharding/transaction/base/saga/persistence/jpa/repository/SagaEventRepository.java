...
package io.opensharding.transaction.base.saga.persistence.jpa.repository;

import io.opensharding.transaction.base.saga.persistence.jpa.entity.SagaEventEntity;
...
public class SagaEventRepository {
    ...
    private final EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory("io.opensharding.transaction.saga.core.persistence");
