...
package io.opensharding.orchestration.reg.zookeeper.natived.client.cache;
...
import io.opensharding.orchestration.reg.zookeeper.natived.client.zookeeper.base.BaseTest;
...
public class PathTreeTest extends BaseTest {
    ...
    public void assertPut() {
        ...
        assertThat(pathTree.getValue("a"), CoreMatchers.is(ZookeeperConstants.NOTHING_DATA));
