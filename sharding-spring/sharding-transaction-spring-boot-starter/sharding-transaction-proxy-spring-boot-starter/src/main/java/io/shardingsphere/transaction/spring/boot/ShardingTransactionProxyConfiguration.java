...
@NoArgsConstructor
public class ShardingTransactionProxyConfiguration {
     ...
     */
    @Bean
    public ShardingTransactionProxyAspect shardingTransactionalAspect() {
        return new ShardingTransactionProxyAspect();
    }
